...
# 260050-SI-99-ActionLaser-XYZController2

**Project ID:** 260050-SI
**Client:** Action Laser Pty Ltd
**Project Title:** XYZ Controller 2
**Derived From:** 260046-SI-99-ActionLaser-LVDTReplacement

## Overview

Actionlaser XYZ Controller 2 project - part of the XYZ Controller series derived from the LVDT Replacement consultation.
...
│   ├── 14-Expenses/     # Internal expense analysis
│   ├── 15-Invoices/     # Invoice documents
│   ├── 18-Metadata/     # Project metadata files
...
├── 50-Deploy/           # Deployment and handover
